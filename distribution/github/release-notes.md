# Make Brand Assets For Me v0.2.2
...
- bundled Instrument Sans Bold/Condensed typography with exact variable-axis settings and no generic fallback;
- an MIT license.
...
Download `make-brand-assets-for-me-0.2.2.zip` below. The SHA-256 digest is stored in `release/manifest.json`.

## Built by Lemonbrand

If the bigger problem is not making a picture but finding the work your team should stop doing, start with a free 60-minute Inbox Audit:

https://lemonbrand.io/inbox-audit?utm_source=github_release&utm_medium=referral&utm_campaign=make_brand_assets_for_me
