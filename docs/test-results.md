...
- The ZIP excludes release files, Python caches, and compiled Python files.

## The picture test

The included baseline has:

- one approval idea in three styles;
- one website handoff scene in three styles;
- one matching four-piece framework set;
