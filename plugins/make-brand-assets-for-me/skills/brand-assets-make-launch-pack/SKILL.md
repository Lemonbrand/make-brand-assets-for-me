...
Read `references/five-steps.md` first. Read `references/ask-the-user.md` when a launch choice is missing. Read `references/channel-placements.json` before sizing files. Read `references/check-the-launch-pack.md` before saving.
